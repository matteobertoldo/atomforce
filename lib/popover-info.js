...
import Button from './button-component'; // eslint-disable-line no-unused-vars
...
export default class PopoverInfo {
    ...
    render () {
        if (this.props.loader) {
            ...
            return (
                <div class="info">
                    Atomforce does not support <span class="text-highlight">multiple repositories</span>. Make sure you have connected only one project.
                    <Button type="reload" click={this.props.click} />
                </div>
            );
            ...
            return (
                <div class="info">
                    <div>
                        Atomforce <span class="text-highlight">is ready to upload</span> file and cartridges. Click on the switcher for enable watching files.
                    </div>
                </div>
            );
        }
