...
export default class PopoverInfo {
  ...
  render() {
    if (this.props.loader) {
      return <span className="loading loading-spinner-tiny" />;
      ...
      return (
        <div className="info">
          Atomforce does not support <span className="text-highlight">multiple repositories</span>. Make sure you have
          connected only one project.
          <Button type="reload" click={this.props.click} />
        </div>
      );
      ...
      return (
        <div className="info fit-content">
          The <span className="text-highlight">dw.json</span> file does not appear in the root of your project.
          <Button />
          <Button type="reload" click={this.props.click} />
        </div>
      );
      ...
      return (
        <div className="info">
          <div>
            Atomforce <span className="text-highlight">is ready to upload</span> file and cartridges. Click on the
            switcher for enable watching files.
          </div>
        </div>
      );
    }
