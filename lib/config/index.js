...
export default {
  statusBar: {
    title: 'Status Bar',
    description: 'Enable or disable Atomforce Status Bar on startup. (Need to reload Atom)',
    type: 'boolean',
    default: true,
    order: 1
  },
  tabOptions: {
    ...
    properties: {
      filesSize: {
        title: 'Files size show by default on tab',
        description:
          'Enable or disable the default displayed size of the files in the tab without clicking on the options menu.',
        type: 'boolean',
        default: true,
        order: 1
      },
      filesInTab: {
        title: 'Maximum files show on tab',
        description:
