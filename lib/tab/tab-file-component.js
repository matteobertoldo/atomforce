    ...
    render () {
        return (
            <div
                attributes={{
                    ...{
                        class: `dwdav-pathame-item status-${
                            this.props.webDAVData.uploaded ? 'uploaded' : 'not-uploaded'
                        }`
                    },
                ...
                <span
                    className={`icon icon-${this.props.webDAVData.uploaded ? 'file' : 'issue-opened'}${
                        this.props.webDAVData.uploaded &&
                        this.props.webDAVData.extension === '' &&
                        !this.props.webDAVData.isFile
                            ? '-directory'
                            : ''
                    } status-${this.status(this.props.webDAVData)}`}></span>
